...
var specialJoke = "What do you call the cutest, kindest and funniest programmer? Mattia.";

function getJoke() {
    var jokeTypeIndex = Math.floor(Math.random() * 3) + 1;      //number from 1-3
    //if (jokeTypeIndex == 1 || jokeTypeIndex == 2) {           //if joke type is from the public API (66% chance over the other type)
